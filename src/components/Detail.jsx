...
const Detail = () => {
  ...
  const [editedUser, setEditedUser] = useState({userId: '', id: '', title: ''});
          ...
          return (
            <div  key={index}>
              <article  className="album-item">
                <img src='https://static.vecteezy.com/system/resources/thumbnails/000/439/863/small/Basic_Ui__28186_29.jpg' className="photo" alt="dummy-photo" />
